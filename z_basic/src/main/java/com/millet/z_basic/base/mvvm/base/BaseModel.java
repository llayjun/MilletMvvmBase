...
import com.millet.z_basic.net.RetrofitApiService;
import com.millet.z_basic.net.RetrofitManager;
import com.millet.z_basic.net.bean.ParamsBuilder;
import com.millet.z_basic.net.bean.Resource;
import com.millet.z_basic.net.bean.ResponseModel;
import com.millet.z_basic.net.downloadutils.DownFileUtils;
...
import com.millet.z_basic.net.uploadutils.UploadFileRequestBody;
                    ...
                    public ObservableSource<?> apply(Observable<Throwable> throwableObservable) throws Exception {
                        return throwableObservable.flatMap(new Function<Throwable, ObservableSource<?>>() {
                            ...
                            public ObservableSource<?> apply(Throwable throwable) throws Exception {
                                ...
                                //如果还没到次数，就延迟5秒发起重连
                                Logger.i("我看看是不是在重连", "当前的重连次数 == " + currentCount[0]);
